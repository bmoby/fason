...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="fa fa-trash-o fileinputicons" aria-hidden="true"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<img src="/images/close.png" class="btnDeleteZoomImg">', //'<i class="glyphicon glyphicon-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        zoomIcon: '<i class="fa fa-search-plus fileinputicons" aria-hidden="true"></i>',
        zoomClass: 'btn btn-xs btn-default',
        zoomTitle: 'Zoom image',
        dragIcon: '<i class="fa fa-hand-pointer-o fileinputicons" aria-hidden="true"></i>',
        dragClass: 'text-info',
    ...
    tMain1 = '{preview}\n' +
        ...
        '</div>';
    tMain2 = '{preview}\n<div class="kv-upload-progress hide"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n';
    tPreview = '<div class="file-preview {class}" data-tipso = "Add at least 3 photos to make attractive your stylebox.">\n' +
        '    {close}' +
        '    <div class="{dropClass}">\n' +
    ...
    tActions = '<div class="file-actions">\n' +
      ...
      //  '    <div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>\n' +
        ...
        '</div>';
    //noinspection HtmlUnknownAttribute
    tActionDelete = '<button type="button" class="btnDelete kv-file-remove {removeClass}" ' + 'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
    //tActionUpload = '<button type="button" class="btnUpload kv-file-upload {uploadClass}" title="{uploadTitle}">' +
        '{uploadIcon}</button>';
    tActionZoom = '<button type="button" class="btnZoom kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>';
    ...
    FileInput.prototype = {
        ...
        _renderMain: function () {
            var self = this, dropCss = (self.isUploadable && self.dropZoneEnabled) ? ' file-drop-zone' : 'file-drop-disabled',
                ...
                caption = self.captionTemplate.replace(/\{class}/g, css + ' kv-fileinput-caption hidden');
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<img src="/images/arrow-left.png" class="btnCloseFSImg">',
            next: '<img src="/images/arrow-right.png" class="btnCloseFSImg">',
            // toggleheader: '<i class="glyphicon glyphicon-resize-vertical"></i>',
            // fullscreen: '<i class="glyphicon glyphicon-fullscreen"></i>',
            // borderless: '<i class="glyphicon glyphicon-resize-full"></i>',
            close: '<img src="/images/close.png" class="btnCloseFSImg">'
        },
        ...
        removeIcon: '<img src="/images/close.png" class="btnCloseFSImg">',
        removeClass: 'btn btn-default',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<img src="/images/close.png" class="btnCloseFSImg">',//'<i class="glyphicon glyphicon-upload"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgFoldersNotAllowed: 'Drag and drop images only! {n} folder(s) dropped were skipped.',
        ...
        dropZoneTitle: 'Drag and drop images here &hellip;',
